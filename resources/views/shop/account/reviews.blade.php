...
@section('title', 'My Reviews - AliarLIE Clothing')
        ...
        <div class="col-lg-12">
          <div class="page-title-content">
            ...
            <div class="bread-crumbs">
              ...
              <span class="active">My Reviews</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="account-dashboard-area mb-5 mt-5">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-9">
          <h1 class="account-page-title mb-4">My Reviews</h1>
          <div class="account-card">
            <div class="account-card-header">
              <h5 class="account-card-title">Product Reviews</h5>
            </div>
            <div class="account-card-body">
              <div class="text-center py-5">
                <p class="text-muted mb-3">No reviews yet.</p>
                <p class="text-muted small">Your product reviews will appear here.</p>
              </div>
            </div>
          </div>
        </div>
