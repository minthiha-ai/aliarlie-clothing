...
@section('title', 'My Payment Options - AliarLIE Clothing')
        ...
        <div class="col-lg-12">
          <div class="page-title-content">
            ...
            <div class="bread-crumbs">
              ...
              <span class="active">My Payment Options</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="account-dashboard-area mb-5 mt-5">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-9">
          <h1 class="account-page-title mb-4">My Payment Options</h1>
          <div class="account-card">
            <div class="account-card-header">
              <h5 class="account-card-title">Saved Payment Methods</h5>
            </div>
            <div class="account-card-body">
              <div class="text-center py-5">
                <p class="text-muted mb-3">No payment methods saved yet.</p>
                <p class="text-muted small">Payment methods will be saved here after your first checkout.</p>
              </div>
            </div>
          </div>
        </div>
